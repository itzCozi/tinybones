...
async function updateTemplate() {
  ...
  try {
    ...
    console.log("============================");
    console.log("This will update your TinyBones blog with the latest template code");
    console.log("while preserving your content.");
    console.log("\n" + chalk.yellow("⚠️ Warning:") + " Make sure to commit or back up your changes before proceeding!");
    ...
    if (fs.existsSync(configPath)) {
      try {
        ...
        console.warn(
          chalk.yellow("Failed to parse .tinybones-config.json, using default configuration")
        );
      }
    } else {
      console.log(
    ...
    try {
      ...
      console.log(
        chalk.yellow("Try to manually resolve the issues and run the update again.")
      );
    }
