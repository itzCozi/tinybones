  ...
  try {
    ...
    if (fs.existsSync(configPath)) {
      try {
        ...
        console.warn('Failed to parse .tinybones-config.json, using default configuration');
      }
    } else {
    ...
    try {
      ...
      console.log(`Review the changes, and if everything looks good, merge them into your main branch.`);
